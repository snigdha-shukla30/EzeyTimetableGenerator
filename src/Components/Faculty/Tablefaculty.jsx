...
const THUMB_HEIGHT_PX = 56 // 7vh approx
...
const Tablefaculty = () => {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      // ✅ FIX: max thumbTop = trackHeight - thumbHeight so thumb stays inside
  ...
  return (
    <>
      ...
      >
        <h1 className="text-2xl md:text-3xl mt-4 ml-0 font-bold text-[#265768]">
          View / Edit generated schedules
        </h1>
        <p className="text-xs md:text-sm mt-1 ml-1 font-medium" style={{ color: 'rgba(38, 87, 104, 0.5)' }}>
          Faculty wise schedules
        </p>

        <div>
          <p className="text-base md:text-sm font-medium text-[#265768] mt-8 ml-1">
            Enter Faculty Name
          </p>
        ...
        >
          {/* table scroll area - browser scrollbar hidden */}
          <div
            ref={tableRef}
