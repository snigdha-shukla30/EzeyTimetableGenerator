...
export default function Subjects({ searchQuery = "", refreshTrigger = 0 }) {
  ...
  return (
    <DataEntryTable columns={columns}>
      {loading && (
        <tr>
          <td colSpan={6} className="py-10 text-center text-[#8A96A8]">
            Loading subjects...
          </td>
        </tr>
      )}
            ...
            <td className="py-5 text-center text-[#4C5968]">
              {editingId === sub._id ? (
                <input
                  ...
                  className="w-[220px] px-2 py-1 border rounded text-center"
                />
              ) : (
                sub.name
              )}
            ...
            <td className="py-5 text-center">
              {editingId === sub._id ? (
                <input
                  ...
                  className="w-[160px] px-2 py-1 border rounded text-center"
                />
              ) : (
                <span className="text-[#1A8FE3] text-[13px] font-medium">
                  {sub.code}
                </span>
              )}
            </td>
            ...
            <td className="py-5 text-center text-[#8A96A8]">
              {editingId === sub._id ? (
                <input
                  ...
                  className="w-[140px] px-2 py-1 border rounded text-center"
                />
              ) : (
                sub.type
              )}
            ...
            <td className="py-5 text-center text-[#8A96A8]">
              {editingId === sub._id ? (
                <input
                  ...
                  className="w-[110px] px-2 py-1 border rounded text-center"
                />
              ) : (
                sub.hoursPerWeek
              )}
            ...
            <td className="py-5">
              {editingId === sub._id ? (
                <div className="flex justify-center gap-2">
                  <button onClick={handleUpdate} className="text-[#1A8FE3]">
                    Save
                  </button>
                  <button onClick={handleCancelEdit} className="text-[#8A96A8]">
                    Cancel
                  </button>
                </div>
              ) : (
